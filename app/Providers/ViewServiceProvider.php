...
class ViewServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        View::composer('users/*', 'App\Http\View\Composers\RoleProfileComposer');
        View::composer('*', 'App\Http\View\Composers\StatusProfileComposer');
        View::composer(['users/*', 'livewire/update-locale-form'], 'App\Http\View\Composers\LocaleProfileComposer');

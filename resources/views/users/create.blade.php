<x-app-layout>
    ...
    <x-main>
            ...
            <x-slot name="form">
                <div class="col-span-6 sm:col-span-4 grid gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-4" x-data="{ show: true }">
                        ...
                        <div class="relative">
                            <input id="password" name="password" :type="show ? 'password' : 'text'" value="{{ old('password') }}" class="mt-1 block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" required="required" minlength="8" autocomplete="new-password" />
        ...
        <x-form-section :submit="route('users.import')" method="post" enctype="multipart/form-data">
            ...
            <x-slot name="description">
                {{ __('Upload a batch of users through a .csv file.') }}
            </x-slot>
            ...
            <x-slot name="form">
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <div x-data="{ fileName: '' }" class="bg-white mt-1 w-full relative p-4 text-gray-400 border border-gray-300 rounded-md shadow-sm">
                        <div x-ref="dnd"
                            class="relative text-gray-400 border-2 border-gray-200 border-dashed rounded cursor-pointer">
                            <input accept="*" type="file" name="file" title="" x-ref="file" @change="fileName = $refs.file.files[0].name" 

            ...
            <x-slot name="form">
                ...
                <div class="col-span-6 sm:col-span-4 grid gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-jet-input autofocus="autofocus" id="name" name="name" type="text" class="mt-1 block w-full" value="{{ old('name', $section->name) }}" required="required" />
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-select id="stagelevel_id" name="stagelevel_id" class="mt-1 block w-full" :options="$stagelevels" :selected="$section->stagelevel_id" />
                ...
                <div class="col-span-6 sm:col-span-2 sm:pl-6">
                    <a role="button" href="{{ route('sections.show', $section) }}" class="block mt-2 sm:mt-8 text-xs text-gray-400 hover:text-gray-300 active:text-gray-400 disabled:opacity-25 transition">

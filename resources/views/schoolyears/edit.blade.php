            ...
            <x-slot name="form">
                ...
                <div class="col-span-6 sm:col-span-4 grid gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-jet-input autofocus="autofocus" id="name" name="name" type="text" class="mt-1 block w-full" value="{{ old('name', $schoolyear->name) }}" required="required" />
                ...
                <div class="col-span-6 sm:col-span-2 sm:mt-6  sm:pl-6">
                    ...
                    <span id="status" class="mt-1 px-2 inline text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100">
                        {{ __( $status[true] ) }}
                    </span>

                    <dfn title="{{ __('Active school years cannot be eliminated.') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="ml-2 inline h-5 w-5 text-gray-300 dark:text-gray-700" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd" />
                        </svg>
                    </dfn>
                    @else
                    <span id="status" class="mt-1 px-2 inline text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800 dark:bg-red-800 dark:text-red-100">
                        {{ __( $status[false] ) }}
                    </span>
                    @endif
                    <a role="button" href="{{ route('schoolyears.show', $schoolyear) }}" class="block mt-2 sm:mt-6 text-xs text-gray-400 dark:text-gray-600 hover:text-gray-500 active:text-gray-400 dark:active:text-gray-600 disabled:opacity-25 transition">

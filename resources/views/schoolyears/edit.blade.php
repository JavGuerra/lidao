        ...
        <x-form-section :submit="route ('schoolyears.update', $schoolyear)" method="PUT">
            ...
            <x-slot name="form">
                ...
                <div class="col-span-6 sm:col-span-2 sm:mt-6  sm:pl-6">
                    ...
                    @endif
                    <a role="button" href="{{ route('schoolyears.show', $schoolyear) }}" class="block mt-2 sm:mt-6 text-xs text-gray-400 hover:text-gray-300 active:text-gray-400 disabled:opacity-25 transition">

        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="max-w-full sm:mx-auto mb-4">
                <div class="sm:flex sm:space-x-4">
                    ...
                    <a href="{{ route('sections.index') }}" class="inline-block align-bottom bg-white rounded-lg text-left hover:scale-105 overflow-hidden shadow-lg transform transition-all mb-4 w-full sm:w-1/4 ">
                        <div class="bg-white p-5 flex items-stretch">
                            <div class="sm:flex sm:items-start w-3/4 sm:w-2/3">
                                <div class="text-center sm:mt-0 sm:ml-2 sm:text-left">
                                    <h3 class="uppercase text-sm leading-6 font-medium text-gray-400">{{__('Sections')}}</h3>
                                    <p class="text-3xl font-bold text-black">{{ $sections }}</p>
                                </div>
                            </div>
